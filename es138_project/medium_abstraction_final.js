...
//     topBottomColor = random([mid1, dark1]);
//     sideColor = random([light, mid2]);

//   } else if ((i + j) % 3 === 0 || random(1) < 0.5) {
//     topBottomColor = random([mid2, dark2]);
//     sideColor = mid1;
//   }
//   else {
//     topBottomColor = dark1;
//     sideColor = mid1;
//   }
...
//   let topColor =
//   topColors[(i + j) % topColors.length];

//   let rightColor =
//   sideColors[(i + j + 1) % sideColors.length];

//   let leftColor =
//   sideColors[(i + j + 2) % sideColors.length];

//   let bottomColor =
//   bottomColors[(i + j) % bottomColors.length];
